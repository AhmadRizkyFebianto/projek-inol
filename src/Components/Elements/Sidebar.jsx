    ...
    <>
                ...
                <form className="p-4 space-y-3" onSubmit={handleSubmit}>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setDp(unformatRupiah(e.target.value))}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-blue-400 rounded-lg bg-gray-200"
                      readOnly
                    />
                  </div>
                ...
                <form className="p-4 space-y-4" onSubmit={handleSubmitSimulasi}>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setGaji(unformatRupiah(e.target.value))}
                      className="w-full px-3 py-2 border border-blue-400 rounded-lg focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
      ...
      >
        ...
        <p className="text-center mb-6">
          Tentukan solusi biaya rumah yang sesuai dengan kemampuan finansial
          kamu!
        </p>
        ...
        <button
          ...
          className="w-4/5 py-6 text-xl font-semibold text-white bg-green-600 rounded-xl hover:bg-green-700 mb-4"
        >
          Hitung KPR
        </button>
